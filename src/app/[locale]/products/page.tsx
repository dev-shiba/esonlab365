...
export default function ProductsPage() {
    ...
    const productSchema = {
        ...
        "@type": "Product",
        name: `${t('product_title_line1')} ${t('product_title_line2')}`,
        description: t('description'),
        image: [
            `${baseUrl}/product_hero.webp`,
            `${baseUrl}/product_tube_open.png`,
            `${baseUrl}/product_box_front.png`,
            `${baseUrl}/ad_material_2.png`
        ],
        brand: {
            "@type": "Brand",
            name: "ESONLAB DAYZ",
        ...
        review: [
            {
                ...
                author: {
                    "@type": "Person",
                    name: locale === "ko" ? "만족한 고객" : "Satisfied Customer"
                },
                reviewBody: locale === "ko"
                    ? "색소와 향료가 없어서 민감한 피부에도 자극 없이 사용할 수 있어요. 수분감도 정말 좋습니다!"
                    : "No pigments or fragrances, so it's gentle on sensitive skin. The hydration is amazing!"
            }
        ]
    };
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-20 lg:gap-24">
                        ...
                        >
                            <Image
                                ...
                                alt="스피룰365 그린 수분 크림 패키지 - 쌀겨수 67%와 스피룰리나로 만든 프리미엄 수분 크림"
                                fill
